 ...
 */
$GLOBALS['TL_DCA']['tl_iso_config']['palettes']['default'] .= ';{iso_newsletter_subscription_legend},iso_mail_newsletter_subscription';


/**
 * Add fields to tl_iso_config
 */
$GLOBALS['TL_DCA']['tl_iso_config']['fields']['iso_mail_newsletter_subscription'] = array
(
	'label'                   => &$GLOBALS['TL_LANG']['tl_iso_config']['iso_mail_newsletter_subscription'],
	'exclude'                 => true,
	'inputType'               => 'select',
